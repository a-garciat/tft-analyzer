...
def getStreams(amount):
   ...
   oauth_params={'client_id':'id-here', 'client_secret':'id-here', 'grant_type':'client_credentials'}
   ...
   getstreams_headers={"Authorization":"Bearer "+json_oauth_token["access_token"], 'Client-ID':'id-here'}
   ...
   revoke_oauth_params={'client_id':'id-here', 'token':json_oauth_token["access_token"]}
...
def getGuides(request,trait_name):
   parameters={"part": "id,snippet", "regionCode": "es", "maxResults": "3", "type": "video", "videoCategoryId": "20", "key": "id-here", "q": "q=teamfight tactics guia "+trait_name}
